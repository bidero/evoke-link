...
- 🔁 **Retainery** — cykliczne pozycje rozliczeniowe (abonamenty): co miesiąc cron sam tworzy pozycję z terminem płatności, a Puls pokazuje **MRR** (stały przychód miesięczny) z listą retainerów.
